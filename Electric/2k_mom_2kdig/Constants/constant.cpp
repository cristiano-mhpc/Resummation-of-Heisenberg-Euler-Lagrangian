...
int main()
{
    ...
    int i,k,m,n;
    const int d = 1999; //number of moments used
    const int digits = 2050; //for setting the precision
    ...
    infile2.open("../../construct_P/0_2k_P_block/matrix_p.txt", std::ios_base::in );
    for ( n = 0; n < d+1; n++ )
    {
        for ( m = 0; m < d+1; m++ )
        {

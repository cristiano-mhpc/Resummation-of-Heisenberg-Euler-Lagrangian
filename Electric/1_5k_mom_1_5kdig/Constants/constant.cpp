...
int main()
{
    ...
    int i,k,m,n;
    const int d = 1499; //number of moments used
    const int digits = 1550; //for setting the precision
    ...
    infile2.open("../../construct_P/0_1_5k_P_block/matrix_p.txt", std::ios_base::in );
    for ( n = 0; n < d+1; n++ )
    {
        for ( m = 0; m < d+1; m++ )
        {
